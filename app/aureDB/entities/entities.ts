...
const entities = {
   ...
   [
      ...
      { name: 'content', type: 'bytea', title: 'Contenido', validators: [Validators.required] },
   ...
   [
      ...
      { name: 'boletoid', type: 'bytea', title: 'Boleto',  coleccion: 'Documentos', id: 'id', desc: 'boletoid filename' },
